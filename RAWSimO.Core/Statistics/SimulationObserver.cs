...
namespace RAWSimO.Core.Statistics
{
    ...
    public class SimulationObserver : IUpdateable
    {
        ...
        /// The overall time spent in deciding the station for an order.
        /// </summary>
        private double _timingOrderBatchingLongesttime = 0.0;
        /// <summary>
        /// The overall time spent in deciding the station for an order by MP.
        /// </summary>
        private double _timingOrderBatchingbyMPOverall = 0.0;
        /// <summary>
        /// The overall time spent in deciding the station for an order by MP.
        /// </summary>
        private double _timingOrderBatchingbyziopsOverall = 0.0;
        /// <summary>
        /// The time spent in deciding the station for an order in t=1 by MP.
        /// </summary>
        private double _timingOrderBatchingFirstbyMP = 0.0;
        /// <summary>
        /// The number of times order batching was called for a decision.
        /// </summary>
        private int _timingOrderBatchingCount = 0;
        /// <summary>
        /// The number of times order batching was called for a decision by MP.
        /// </summary>
        private int _timingOrderBatchingbyMPCount = 0;
        /// <summary>
        /// The overall time spent deciding / planning.
        /// </summary>
        ...
        /// <summary>
        /// The time spent in order batching for t=1.
        /// </summary>
        public double TimingOrderBatchingFirstbyMP { get { return _timingOrderBatchingFirstbyMP; } }
        /// <summary>
        /// The overall time spent in order batching.
        /// </summary>
        public double TimingOrderBatchingOverall { get { return _timingOrderBatchingOverall; } }
        /// <summary>
        /// The longest time spent in order batching.
        /// </summary>
        public double TimingOrderBatchingLongesttime { get { return _timingOrderBatchingLongesttime; } }
        /// <summary>
        /// The overall time spent in order batching by MP.
        /// </summary>
        public double TimingOrderBatchingbyMPOverall { get { return (_timingOrderBatchingbyMPOverall - _timingOrderBatchingbyziopsOverall); } }
        /// <summary>
        /// The overall time spent in order batching by MP.
        /// </summary>
        public double TimingOrderBatchingbyziopsOverall { get { return _timingOrderBatchingbyziopsOverall; } }
        /// <summary>
        /// The average time consumed for making a single decision.
        /// </summary>
        ...
        /// The average time consumed for making a single decision.
        /// </summary>
        public double TimingOrderBatchingbyMPAverage { get { return _timingOrderBatchingCount == 0 ? 0 : (_timingOrderBatchingbyMPOverall - _timingOrderBatchingbyziopsOverall) / _timingOrderBatchingbyMPCount; } }
        /// <summary>
        /// The average time consumed for making a single decision.
        /// </summary>
        public double TimingOrderBatchingbyziopsAverage { get { return _timingOrderBatchingCount == 0 ? 0 : _timingOrderBatchingbyziopsOverall / _timingOrderBatchingbyMPCount; } }
        /// <summary>
        ...
        /// <summary>
        /// The number of decisions done for order batching by MP.
        /// </summary>
        public int TimingOrderBatchingDecisionbyMPCount { get { return _timingOrderBatchingbyMPCount; } }
        ...
        public void TimeOrderBatching(double time) 
        { 
            _timingOrderBatchingOverall += time; 
            _timingOrderBatchingCount++; 
            _timingDecisionsOverall += time;
            if (time > _timingOrderBatchingLongesttime && _timingOrderBatchingCount > 1) 
                _timingOrderBatchingLongesttime = time;
        }
        /// <summary>
        /// Signals this monitor that a order batching decision just happened and logs the time it took do decide in s.
        /// </summary>
        /// <param name="time">The time it took to determine the output-station for the order.</param>
        public void TimeOrderBatchingbyMP(double time) 
        {
            _timingOrderBatchingbyMPOverall += time;
            _timingOrderBatchingbyMPCount++;
            if (_timingOrderBatchingFirstbyMP == 0)
                _timingOrderBatchingFirstbyMP = time;
        }
        /// <summary>
        /// Signals this monitor that a order batching decision just happened and logs the time it took do decide in s.
        /// </summary>
        /// <param name="time">The time it took to determine the output-station for the order.</param>
        public void TimeOrderBatchingbyziops(double time)
        {
            _timingOrderBatchingbyziopsOverall += time;
        }
        #endregion
