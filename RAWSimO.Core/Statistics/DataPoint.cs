...
namespace RAWSimO.Core.Statistics
{
    ...
    public class FootprintDatapoint
    {
        ...
        public enum FootPrintEntry
        {
            ...
            /// <summary>
            /// The longest time for order batching.
            /// </summary>
            TimingOrderBatchingLongesttime,
            /// <summary>
            /// The number of order batching calls.
            /// </summary>
            TimingOrderBatchingCount,
            /// <summary>
            /// The number of order batching calls by MP.
            /// </summary>
            TimingOrderBatchingbyMPCount,
            /// <summary>
            /// The average time per order batching call by Mp.
            /// </summary>
            TimingOrderBatchingbyMPAvg,
            /// <summary>
            /// The overall time for order batching by MP.
            /// </summary>
            TimingOrderBatchingbyMPOverall,
            /// <summary>
            /// The average time per order batching call by Mp.
            /// </summary>
            TimingOrderBatchingbyziopsAvg,
            /// <summary>
            /// The overall time for order batching by MP.
            /// </summary>
            TimingOrderBatchingbyziopsOverall,
            /// <summary>
            /// The time of Mp first calls.
            /// </summary>
            TimingOrderBatchingFirstbyMP,
        ...
        public FootprintDatapoint(Instance instance)
        {
            ...
            _entryValues[FootPrintEntry.TimingOrderBatchingLongesttime] = instance.Observer.TimingOrderBatchingLongesttime;
            _entryValues[FootPrintEntry.TimingOrderBatchingCount] = instance.Observer.TimingOrderBatchingDecisionCount;
            _entryValues[FootPrintEntry.TimingOrderBatchingbyMPCount] = instance.Observer.TimingOrderBatchingDecisionbyMPCount;
            _entryValues[FootPrintEntry.TimingOrderBatchingbyMPAvg] = instance.Observer.TimingOrderBatchingbyMPAverage;
            _entryValues[FootPrintEntry.TimingOrderBatchingbyMPOverall] = instance.Observer.TimingOrderBatchingbyMPOverall;
            _entryValues[FootPrintEntry.TimingOrderBatchingbyziopsAvg] = instance.Observer.TimingOrderBatchingbyziopsAverage;
            _entryValues[FootPrintEntry.TimingOrderBatchingbyziopsOverall] = instance.Observer.TimingOrderBatchingbyziopsOverall;
            _entryValues[FootPrintEntry.TimingOrderBatchingFirstbyMP] = instance.Observer.TimingOrderBatchingFirstbyMP;
            // Custom performance info
